...
public class PreferenceKeys {
    ...
    public static String getHdrState() {
        return "preference_hdr_State";
    }

    public static String getFlashAuto() {
        return "preference_flash_auto";
    }

    public static String getFlashOff() {
        return "preference_flash_off";
    }

    public static String getFlashOn() {
        return "preference_flash_on";
    }


    public static String getTimerThree() {
        return "preference_timer_three";
    }

    public static String getTimerFive() {
        return "preference_timer_five";
    }

    public static String getTimerTen() {
